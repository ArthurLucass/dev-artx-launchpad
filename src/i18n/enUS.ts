...
export const enUS = {
  ...
  hero: {
    ...
    subtitle: 'Launch your Portfolio, Website, Landing Page, or Sales Page with stunning speed and style.',
    getStarted: 'Get Started Today →',
    seeWork: 'See Our Work'
  },
  features: {
    title: 'Why Choose Dev Artx?',
    items: [
      {
        icon: '🎨',
  ...
  testimonials: {
    title: 'Testimonials',
    subtitle: 'Don\'t take our word for it - hear what our clients have to say',
    items: [
      {
